...
```text
05_OBS_UD08_LAB_guidato_Tabelle_Azure_Reali_v5_2.md
```

Questa estensione serve a interrogare tabelle effettivamente presenti nel workspace, distinguendo dati didattici controllati e dati Azure reali. Per le VM usare come riferimento Azure Monitor Agent e Data Collection Rules, non la vecchia diagnostica VM legacy.
